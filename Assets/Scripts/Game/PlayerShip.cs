...
public class PlayerShip : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        // мы получаем размеры нашего корабля.
    ...
    private void UpdateKey()
    {
        ...
        // Вращение корабля при горизонтальном перемещении
    ...
    private Vector3 CheckBoardWorld()
    {
        ...
        x = Mathf.Clamp(x, _controller.LeftDownPoint.x + _sizeWorldShip.x,
            _controller.RightDownPoint.x - _sizeWorldShip.x);
        y = Mathf.Clamp(y, _controller.LeftDownPoint.y + _sizeWorldShip.y,
            _controller.LeftUpPoint.y - _sizeWorldShip.y);
